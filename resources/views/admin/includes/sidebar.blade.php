    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a id="ves" class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Manage Leaves</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                ...
                <li class="sidebar-item"> <a id="ves" class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Settings</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        @can('isAdmin')
                        <li class="sidebar-item"><a id="ves" href="{{route('reset')}}" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Reset Leaves </span></a></li>
                        @endcan
